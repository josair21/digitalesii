...
bool S0=0,S1=0,S2=0,J=0,K=0,I=0;
int i=0,j=0,k=0,t=288,l=t,r=18,c=0,p=0;
...
void eqout(){
  ...
  S2=A&&B&&!C&&!D;}
void sel(){  
    if(digitalRead(9)==0){K=0;I=1;delay(t);p=1;}
    else if(digitalRead(8)==0){K=1;I=0;delay(t);p=2;}
    else if(digitalRead(7)==0){K=1;I=1;delay(t);p=3;}
    else {K=0;I=0;}}    
void coin(){
